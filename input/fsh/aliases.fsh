...
// Alias: $ConditionVerificationStatusCS = http://terminology.hl7.org/CodeSystem/condition-ver-
...
// Alias: $DischargeDispositionCS = http://terminology.hl7.org/CodeSystem/discharge-disposition //Deleted, created direct valueset
Alias: $DrugCodesCS = https://verification.fda.gov.ph //FDA Website
// Alias: $EncounterClassificationCS =  http://terminology.hl7.org/CodeSystem/v3-ActCode //Deleted, created direct valueset
...
// Alias: $GenderCS = http://hl7.org/fhir/administrative-gender //Deleted, created direct valueset
Alias: $ICD10CS = http://hl7.org/fhir/sid/icd-10 //ICD Link
Alias: $IdentifierType = http://terminology.hl7.org/CodeSystem/v2-0203
// Alias: $ImmunizationRouteCS = http://terminology.hl7.org/CodeSystem/v3-RouteOfAdministration //Deleted, created direct valueset
// Alias: $ImmunizationStatusCS = http://hl7.org/fhir/event-status //Direct to valueset //Deleted, created direct valueset
// Alias: $ImmunizationStatusReasonCS = http://terminology.hl7.org/CodeSystem/v3-ActReason //Direct to Valueset
...
// Alias: $LocationPhysicalTypeCS = http://terminology.hl7.org/CodeSystem/location-physical-type|4.0.1 //Deleted, created direct valueset
...
// Alias: $ObservationInterpretationCS = http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation //Deleted, created direct valueset 
// Alias: $ObservationMethodCS = http://terminology.hl7.org/CodeSystem/v3-ObservationMethod //Deleted, created direct valueset 
Alias: $ObservationValueCS = https://nhdr.gov.ph/fhir/CodeSystem/ObservationValueCS
// Alias: $OrganizationTypeCS = http://terminology.hl7.org/CodeSystem/organization-type|4.0.1 //Deleted, created direct valueset 
...
// Alias: $ProcedureOutcomeCS = http://terminology.hl7.org/CodeSystem/v2-0241 //Deleted, created direct valueset 
...
// Alias: $ReasonMedicationGivenCS = http://terminology.hl7.org/CodeSystem/reason-medication-given //Deleted, created direct valueset 
// Alias: $RoleCodeCS = http://terminology.hl7.org/CodeSystem/v3-RoleCode //Deleted, created direct valueset for FamilyMemberRelationshipVS
Alias: $RVSCodeCS = https://nhdr.gov.ph/fhir/CodeSystem/RVSCodeCS
Alias: $SexCS = http://terminology.hl7.org/CodeSystem/v2-0001
Alias: $SNOMED = http://snomed.info/sct
// Alias: $ServiceRequestStatusCS = http://hl7.org/fhir/request-status //Deleted, created direct valueset 
Alias: $ServiceTypeCS = http://terminology.hl7.org/CodeSystem/service-type
// Alias: $SpecimenConditionCS = http://terminology.hl7.org/CodeSystem/v2-0493 //Deleted, created direct valueset 
...
Alias: $AppointmentStatusVS = http://hl7.org/fhir/ValueSet/appointmentstatus|4.0.1 // check the local references and the forms, as the forms only use Y or No
...
Alias: $ConditionVerificationStatusVS = http://hl7.org/fhir/ValueSet/condition-ver-status //Deleted VS fsh file
Alias: $CoverageCoPayTypeVS = https://nhdr.gov.ph/fhir/ValueSet/CoverageCoPayTypeVS
Alias: $DiagnosticReportStatusVS = http://hl7.org/fhir/ValueSet/diagnostic-report-status
Alias: $DiagnosticServiceSectionVS = http://hl7.org/fhir/ValueSet/diagnostic-service-sections|4.0.1 //Deleted CS, direct bind to FHIR Valueset
Alias: $DischargeDispositionVS = http://hl7.org/fhir/ValueSet/encounter-discharge-disposition //Deleted fsh file and CodeSystem in Aliases, direct bind to FHIR Valueset
Alias: $DrugCodesVS = https://nhdr.gov.ph/fhir/ValueSet/DrugCodesVS
Alias: $EducationalAttainmentVS = https://nhdr.gov.ph/fhir/ValueSet/EducationalAttainmentVS
Alias: $EncounterClassificationVS = http://terminology.hl7.org/ValueSet/v3-ActEncounterCode //Deleted CodeSystem, direct bind to FHIR Valueset  
Alias: $EncounterStatusVS = http://hl7.org/fhir/encounter-status 
Alias: $FamilyMemberRelationshipVS = http://terminology.hl7.org/ValueSet/v3-FamilyMember //Deleted CodeSystem, direct bind to FHIR Valueset  
Alias: $GenderVS = http://hl7.org/fhir/ValueSet/administrative-gender //Deleted VS fsh file and CodeSystem
Alias: $HealthFacilityVS = https://nhdr.gov.ph/fhir/ValueSet/HealthFacilityVS
...
Alias: $ImmunizationRouteVS = http://hl7.org/fhir/ValueSet/immunization-route //Deleted VS fsh file and CodeSystem in Aliases, direct bind to FHIR Valueset
Alias: $ImmunizationStatusVS = http://hl7.org/fhir/ValueSet/immunization-status //Deleted VS fsh file and CodeSystem in Aliases , direct bind to FHIR Valueset
Alias: $ImmunizationStatusReasonVS = http://terminology.hl7.org/ValueSet/v3-ActNoImmunizationReason //Deleted VS fsh file and CodeSystem in Aliases, direct bind to FHIR Valueset
Alias: $LHIOVS = https://nhdr.gov.ph/fhir/ValueSet/LHIOVS
...
Alias: $MedicationAdministrationStatusVS = http://hl7.org/fhir/ValueSet/medication-admin-status
...
Alias: $ObservationCategoryVS = http://hl7.org/fhir/ValueSet/observation-category|4.0.1
Alias: $ObservationInterpretationVS = http://hl7.org/fhir/ValueSet/observation-interpretation|4.0.1
Alias: $ObservationMethodVS = http://terminology.hl7.org/ValueSet/v3-ObservationMethod
Alias: $ObservationStatusVS = http://hl7.org/fhir/ValueSet/observation-status
Alias: $OccupationClassificationVS = https://nhdr.gov.ph/fhir/ValueSet/OccupationClassificationVS
Alias: $OrganizationTypeVS = http://hl7.org/fhir/ValueSet/organization-type
Alias: $PatientTypeVS = https://nhdr.gov.ph/fhir/ValueSet/PatientTypeVS
Alias: $Barangay = https://nhdr.gov.ph/fhir/ValueSet/BarangayVS
Alias: $City = https://nhdr.gov.ph/fhir/ValueSet/CityVS
Alias: $Province = https://nhdr.gov.ph/fhir/ValueSet/ProvinceVS
Alias: $Region = https://nhdr.gov.ph/fhir/ValueSet/RegionVS
Alias: $PractitionerRoleVS = https://nhdr.gov.ph/fhir/ValueSet/PractitionerRoleVS
Alias: $PROVS = https://nhdr.gov.ph/fhir/ValueSet/ProVS
Alias: $ProcedureOutcomeVS = http://terminology.hl7.org/ValueSet/v2-0241
Alias: $ReasonMedicationGivenVS = http://hl7.org/fhir/ValueSet/reason-medication-given-codes
Alias: $RelationshipTypeVS = http://hl7.org/fhir/ValueSet/relatedperson-relationshiptype
